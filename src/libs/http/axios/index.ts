...
import { setObjToUrlParams, deepMerge } from '/@/libs/utils';
...
const transform: AxiosTransform = {
  ...
  transformRequestHook: (res: AxiosResponse<Result>, options: RequestOptions) => {
    ...
    const hasSuccess =
      ...
      (code === ResultEnum.SUCCESS || code === ResultEnum.SERVER_SUCCESS);
    if (hasSuccess) {
      return result;
    }
...
// todo 封装一个restful风格的公共方法
// export const restfulApi = (methods: ) => {};
